...
public class KerberosApRequest {
    ...
    public KerberosApRequest(byte[] token, KerberosKey[] keys) throws DecodingException {
        ...
        while(fields.hasMoreElements()) {
            ...
            case 0:
                ASN1Integer pvno = DecodingUtil.as(ASN1Integer.class, tagged);
                ...
                break;
            case 1:
                ASN1Integer msgType = DecodingUtil.as(ASN1Integer.class, tagged);
            ...
            case 2:
                ...
                break;
            case 3:
                DLApplicationSpecific derTicket = DecodingUtil.as(DLApplicationSpecific.class,
                        tagged);
