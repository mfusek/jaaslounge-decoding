...
public class KerberosToken {
    ...
    public KerberosToken(byte[] token, KerberosKey[] keys) throws DecodingException {
        ...
        try {
            ...
            DLApplicationSpecific derToken = DecodingUtil.as(DLApplicationSpecific.class, stream);
            ...
            DLApplicationSpecific krbToken = DecodingUtil.as(DLApplicationSpecific.class, stream);
